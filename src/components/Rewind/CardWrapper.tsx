...
/**
 * Base wrapper component for all rewind cards
 * Provides full-screen container with consistent layout and action buttons
 * @param children - Content to be displayed inside the card
 * @param className - Additional CSS classes for customization
 * @returns JSX element with full-screen layout
 */
